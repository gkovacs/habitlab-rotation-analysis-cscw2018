...
library(stargazer)
stargazer(results, covariate.labels = c("Rotation (baseline: static)", "(Intercept)"), dep.var.labels=c("Log time spent per day", "(Intercept)"), no.space=TRUE, title="Daily time spent on sites in the static and rotation conditions. Users spend less time per day on sites in the random condition.", label="tab:effectiveness_same_vs_random", table.placement = "tb")
```
