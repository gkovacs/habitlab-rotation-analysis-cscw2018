...
basepath <- '/Users/msb/Dropbox (Stanford HCI)/projects/habitlab/habitlab_data_analysis/'
...
summary(results)
library(stargazer)
#stargazer(results, covariate.labels = c("(Intercept)", "Number of days the intervention has been seen"), dep.var.labels=c("Log time spent"), align=TRUE, no.space=TRUE)
stargazer(results)
```
