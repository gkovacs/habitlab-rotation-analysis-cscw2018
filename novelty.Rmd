...
ndata <- subset(datadays, domain == 'www.facebook.com' | domain == 'www.youtube.com' | domain == 'www.reddit.com' | domain == 'twitter.com' | domain == 'vk.com')
ndata <- subset(ndata, condition == 'same')
#summary(ndata)

results <- lmer(log_time_spent ~ num_days_in_same_condition + (1|domain) + (1|install_id), data = ndata)
resultsnull <- lmer(log_time_spent ~ (1|domain) + (1|install_id), data = ndata)
anova(resultsnull, results)
summary(results)
