import pandas as pd
import json
from extract_dataframe import extract_dataframe, extract_dataframe_daily, extract_dataframe_peruser, is_default_facebook_intervention, is_default_youtube_intervention, at_least_two_conditions, is_facebook, is_youtube, exclude_first_day, exclude_last_day
...
def extract_to_file_with_filters_peruser(filename):
  extract_dataframe_peruser(alldata).to_csv(filename, index=False)
...
extract_to_file_with_filters_peruser(datafile_base + '_peruser.csv')
