...
ggsurvplot(fit,
          ...
          ggtheme = theme_bw(), # Change ggplot2 theme
          palette = c("#E7B800", "#444444", "#2E9FDF"),
          xlab="Days HabitLab is installed",
          xlim=c(0, 70),
          break.x.by = 10,
          legend="bottom",
          legend.labs = c("One default", "Half of defaults", "All defaults")
          )
...
stargazer(coxresult, 
          covariate.labels = c("Half of defaults (baseline: one default)", "All defaults"), 
